...
<title>OpenWeatherMap Forecast script - Demo Page</title>
<style type="text/css">
/*--------------------------------------------------
  tabbertab 
  --------------------------------------------------*/
...
$SITE['WULanguages'] = array ( // for WeatherUnderground forecast supported languages
  ...
  print "<h1>Demo page for OWM-forecast.php</h1>\n";
  ...
  foreach ($SITE['installedLanguages'] as $lang => $langName) {
	...
	include_once("OWM-forecast.php");
	print "</div>\n";


?>
<hr />
<p>See the <a href="https://github.com/ktrue/Weather-PHP/tree/master/forecast/OpenWeatherMap">script page</a> for documentation and downloads.</p>
</body>
</html>